...
class LibMetaData:
    ...
    WS_ALL_SCAN_SUFFICES = {"**/*.7z", "**/*.a", "**/*.aar", "**/*.air", "**/*.apk", "**/*.ar", "**/*.bz2", "**/*.car",
                            "**/*.conda", "**/*.cpa", "**/*.crate", "**/*.deb", "**/*.dll", "**/*.dmg", "**/*.docker",
                            "**/*.drpm", "**/*.ear", "**/*.egg", "**/*.epk", "**/*.exe", "**/*.gal", "**/*.gem",
                            "**/*.gzip", "**/*.har", "**/*.hpi", "**/*.jar", "**/*.jar.pack.gz", "**/*.jpi", "**/*.js",
                            "**/*.ko", "**/*.min.js", "**/*.msi", "**/*.nupkg", "**/*.pkg.tar.xz", "**/*.rpm",
                            "**/*.sar", "**/*.sit", "**/*.so", "**/*.swc", "**/*.swf", "**/*.tar", "**/*.tar.bz2",
                            "**/*.tar.gz", "**/*.tbz", "**/*.tgz", "**/*.udeb", "**/*.war", "**/*.whl", "**/*.zip",
                            ...
                            "**/*.applescript", "**/*.arc", "**/*.as", "**/*.asax", "**/*.asc", "**/*.ascx", "**/*.asd",
                            "**/*.ash", "**/*.ashx", "**/*.asmx", "**/*.asp", "**/*.aspx", "**/*.au3", "**/*.aug",
                            "**/*.auk", "**/*.aw", "**/*.awk", "**/*.axd", "**/*.axi", "**/*.axi.erb", "**/*.axs",
                            "**/*.axs.erb", "**/*.b", "**/*.bas", "**/*.bash", "**/*.bat", "**/*.bats", "**/*.bb",
                            "**/*.befunge", "**/*.bf", "**/*.bison", "**/*.bmx", "**/*.bones", "**/*.boo", "**/*.boot",
                            "**/*.brd", "**/*.bro", "**/*.brs", "**/*.bsl", "**/*.bsv", "**/*.builder", "**/*.bzl",
                            "**/*.c", "**/*.c++", "**/*.cake", "**/*.capnp", "**/*.cats", "**/*.cbl", "**/*.cc",
                            ...
                            "**/*.cobol", "**/*.coffee", "**/*.com", "**/*.command", "**/*.coq", "**/*.cp", "**/*.cpp",
                            "**/*.cps", "**/*.cpy", "**/*.cr", "**/*.cs", "**/*.csd", "**/*.cshtml", "**/*.csx",
                            "**/*.ctp", "**/*.cu", "**/*.cuh", "**/*.cw", "**/*.cxx", "**/*.cy", "**/*.d", "**/*.dart",
                            "**/*.dats", "**/*.db2", "**/*.dcl", "**/*.decls", "**/*.dfm", "**/*.di", "**/*.djs",
                            "**/*.dlm", "**/*.dm", "**/*.do", "**/*.doh", "**/*.dpr", "**/*.druby", "**/*.duby",
                            "**/*.dyalog", "**/*.dyl", "**/*.dylan", "**/*.e", "**/*.ec", "**/*.ecl", "**/*.eclxml",
                            "**/*.eh", "**/*.el", "**/*.eliom", "**/*.eliomi", "**/*.elm", "**/*.em", "**/*.emacs",
                            ...
                            "**/*.fxh", "**/*.fy", "**/*.g", "**/*.g4", "**/*.gap", "**/*.gawk", "**/*.gd", "**/*.gdb",
                            "**/*.gdbinit", "**/*.gemspec", "**/*.geo", "**/*.geom", "**/*.gf", "**/*.gi", "**/*.glf",
                            "**/*.glsl", "**/*.glslv", "**/*.gml", "**/*.gms", "**/*.gnu", "**/*.gnuplot", "**/*.go",
                            "**/*.god", "**/*.golo", "**/*.gp", "**/*.grace", "**/*.groovy", "**/*.grt", "**/*.gs",
                            "**/*.gshader", "**/*.gsp", "**/*.gst", "**/*.gsx", "**/*.gtpl", "**/*.gvy", "**/*.gyp",
                            "**/*.gypi", "**/*.h", "**/*.h++", "**/*.hats", "**/*.hb", "**/*.hcl", "**/*.hh", "**/*.hic",
                            "**/*.hlean", "**/*.hlsl", "**/*.hlsli", "**/*.hpp", "**/*.hqf", "**/*.hrl", "**/*.hs",
                            "**/*.hsc", "**/*.hx", "**/*.hxsl", "**/*.hxx", "**/*.hy", "**/*.i7x", "**/*.iced",
                            "**/*.icl", "**/*.idc", "**/*.idr", "**/*.ihlp", "**/*.ijs", "**/*.ik", "**/*.ily",
                            "**/*.inc", "**/*.inl", "**/*.ino", "**/*.intr", "**/*.io", "**/*.ipf", "**/*.ipp",
                            "**/*.irbrc", "**/*.iss", "**/*.j", "**/*.jake", "**/*.java", "**/*.jbuilder", "**/*.jflex",
                            "**/*.ji", "**/*.jison", "**/*.jisonlex", "**/*.jl", "**/*.jq", "**/*.js", "**/*.jsb",
                            "**/*.jscad", "**/*.jsfl", "**/*.jsm", "**/*.jsp", "**/*.jss", "**/*.jsx", "**/*.kicad_pcb",
                            "**/*.kid", "**/*.krl", "**/*.ksh", "**/*.kt", "**/*.ktm", "**/*.kts", "**/*.l", "**/*.lagda",
                            "**/*.las", "**/*.lasso", "**/*.lasso8", "**/*.lasso9", "**/*.ldml", "**/*.lean", "**/*.lex",
                            "**/*.lfe", "**/*.lgt", "**/*.lhs", "**/*.lid", "**/*.lidr", "**/*.lisp", "**/*.litcoffee",
                            ...
                            "**/*.mt", "**/*.mu", "**/*.muf", "**/*.mumps", "**/*.mxt", "**/*.myt", "**/*.n", "**/*.nawk",
                            ...
                            "**/*.pascal", "**/*.pasm", "**/*.pat", "**/*.pb", "**/*.pbi", "**/*.pbt", "**/*.pck",
                            "**/*.pd", "**/*.pd_lua", "**/*.pde", "**/*.perl", "**/*.ph", "**/*.php", "**/*.php3",
                            "**/*.php4", "**/*.php5", "**/*.phps", "**/*.phpt", "**/*.pig", "**/*.pike", "**/*.pir",
                            ...
                            "**/*.yap", "**/*.yrl", "**/*.yy", "**/*.zep", "**/*.zimpl", "**/*.zmpl", "**/*.zpl", "**/*.zsh"}
